...
const StatCard = ({ title, value, subtitle = '', icon: Icon, trend = 'neutral', color = 'blue' }) => (
      ...
      <div className="bg-white border-b border-slate-200">
        <div className="px-6 py-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-slate-900">Finance Core - Journals & GL</h1>
              <p className="text-sm text-slate-500">General Ledger, Journals, Approvals & SAP Integration</p>
            </div>
          </div>
        </div>
        <div className="px-6">
